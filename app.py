...
def create_pdf(text):
    ...
    # --- 1. Header (Professional Blue Title) ---
    pdf.set_font("Arial", 'B', 18)
    pdf.set_text_color(0, 51, 102)  # Dark Blue
    pdf.cell(0, 15, "ATS ANALYSIS REPORT", ln=True, align='C')
    ...
    # Cleaning Markdown & Special Characters (The Ultimate Fix)
    # Sabse pehle markdown hatao
    clean_text = text.replace("**", "").replace("###", "").replace("##", "").replace("#", "").replace("*", "-")
    
    # Phir aise characters hatao jo PDF support nahi karta (Unicode to Latin-1)
    # Is line se saare error khatam ho jayenge
    ...
    pdf.cell(0, 10, "Generated by GetShortlisted AI | getshortlisted.online", align='C')
